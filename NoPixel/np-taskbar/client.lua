...
AddEventHandler('event:control:taskBar', function(useID)
    if useID == 1 and not insidePrompt and not focusTaken then
        TriggerEvent("radioGui")
    elseif useID == 2 and not insidePrompt and not focusTaken then
        TriggerEvent("stereoGui")
    elseif useID == 3 and not insidePrompt and not focusTaken then
        TriggerEvent("phoneGui")
    elseif useID == 4 and not insidePrompt and not focusTaken then
