		...
		--	end
			...
			if GetDistanceBetweenCoords(PlayerPos, 2221.7973632813,5577.0966796875,53.844783782959, true) <= 10 then		
				...
				if JustDriedWeed then
					TriggerEvent("DoLongHudText","You are too tired from drying weed, either wait 15 minutes or get help!")
				else
			...
			if GetDistanceBetweenCoords(PlayerPos, 3803.58, 4444.46, 4.1, true) <= 15 then						
				...
				if JustPickedWeed then
					TriggerEvent("DoLongHudText","You are too tired from gathering weed, either wait 15 minutes or get help!")
				else
					...
					if wetbud then
						...
						TriggerEvent("DoShortHudText","You need atleast 5 buds to dry here.")
					end
				end
			end	
